...
## Unofficial Grafana MongoDB Atlas Datasource Release

- **1.0.0** Initial unofficial release
  - This is an unofficial release of the Grafana MongoDB Atlas Datasource plugin previously maintained by Valiton GmbH. The plugin has been renamed to `fernandoescolar-mongodbatlas-datasource` to reflect its unofficial status.
  - All dependencies have been updated to their latest versions, and the plugin has been tested with the latest Grafana releases to ensure compatibility and stability.

## Old Valiton Releases
...
- **2.0.0** Add Metric & Improve Documentation
  ...
  - Add LOGICAL_SIZE Metric [#32](https://github.com/fernandoescolar/grafana-mongodb-atlas-datasource/issues/32)
  - Add security fixes
  - Update authentication images in README

- **1.1.0** - Fix alerting errors
  https://github.com/fernandoescolar/grafana-mongodb-atlas-datasource/commit/8efac61b1d1eb7915373028e2f98986c2c42923a

- **1.0.4** - Fix alerting errors

  https://github.com/fernandoescolar/grafana-mongodb-atlas-datasource/pull/15
